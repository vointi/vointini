<script lang="ts">
    ...
    import type {DTOHeightAdd} from "../dto";
    ...
    const {form} = createForm({
        onSubmit: async (values, event) => {
            ...
            const wval: DTOHeightAdd = <DTOHeightAdd>{
    ...
    <Table class="table-striped table table-dark">
        ...
        <tr> <!-- Height-->
            ...
            <td>
                ...
                <input class="form-control numval" type="number" min="0" id="height" name="height" bind:value={height}
                       placeholder="Height">
